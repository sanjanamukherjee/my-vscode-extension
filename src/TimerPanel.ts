...
export class TimerPanel {
  ...
  public static readonly viewType = "timer-panel";
  ...
  public static createOrShow(extensionUri: vscode.Uri) {
    ...
    if (TimerPanel.currentPanel) {
      ...
      TimerPanel.currentPanel._update();
      return;
    }
  ...
  public static kill() {
    TimerPanel.currentPanel?.dispose();
  ...
  private _getHtmlForWebview(webview: vscode.Webview) {
    ...
    const scriptUri = webview.asWebviewUri(
      ...
      //   vscode.Uri.joinPath(this._extensionUri, "out\compile", "main.js")
    );
